      ...
      .then(
        (result) => {
          ...
          this.setState({
            ...
            phone: "",
            description: "",
			subject: "Notification: Message From Audie O'Toole Photo Portfolio"
          });
        },
        (error) => {
        ...
        <div className="contact-content flex-c">
          <div className="contact-left">
            ...
            <div className="contact-details">
              ...
              <p>
                <FaEnvelope className="react-icons" /> : audieotoole@gmail.com
              </p>
              <p>
                <FaPhone className="react-icons" /> : (763) 220-0042
              </p>
              <p>
                <FaMapMarker className="react-icons" /> : Nampa, Idaho
              </p>
            </div>
          </div>
